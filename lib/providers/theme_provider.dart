...
class ThemeProvider with ChangeNotifier {
  ...
  void initialize() async {
    ...
    var systemMode = SchedulerBinding.instance.platformDispatcher.platformBrightness;
    ...
    appBarIconPath = theme!.brightness == Brightness.dark ? 'assets/app/app_bar_icon_dark.png' : 'assets/app/app_bar_icon.png';
    notifyListeners();
    initialized = true;
  }
  ...
  Future<void> setTheme(ThemeData newTheme) async {
    final sharedPreferences = await SharedPreferences.getInstance();
    String themeMode = newTheme.brightness == Brightness.dark ? 'dark' : 'light';
